    ...
    return (<Card {...props}>
        <CardContent>
            ...
            <Box sx={styles.latestVideoContainer} >
                <Box sx={styles.latestVideoThumbnail} component={'img'} src={'src/assets/dolphin.jpg'} />
                <Typography sx={styles.latestVideoTitle}>Dazzling Dolphins: Aquatic Acrobats in Action!</Typography>
            </Box>
