        ...
        <Box sx={styles.columnsContainer}>
            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Box sx={styles.postAuthorSection}>
                        <Avatar sx={styles.avatar} alt="Masoud" src="src/assets/avatars/me.png" />
                        <Typography sx={styles.postMeta}>Travel Together</Typography>
                        <Typography sx={styles.postMeta}>Jan 19, 2023</Typography>
                    </Box>
                    <Typography variant="body2">Awe-inspiring elegance! The dolphins' graceful maneuvers and playful antics in the water are truly a sight to behold.</Typography>
            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Box sx={styles.videoStatsRow}>
                        <Typography variant="h7">Serenity Unveiled: Exploring Tranquil Forests and Hidden Delights</Typography>
                        <Typography variant="h7">450</Typography>
                    </Box>
                    <Box sx={styles.videoStatsRow}>
                        <Typography variant="h7">Untamed Majesty: Roaming with Lions in the African Savannah</Typography>
                        <Typography variant="h7">287</Typography>
                    </Box>
                    <Box sx={styles.videoStatsRow}>
                        <Typography variant="h7">Whispers of the Wilderness: Discovering the Enigmatic Beauty of Deep Forests</Typography>
            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Box sx={styles.commentRow}>
                        <Avatar sx={styles.avatar} alt="Masoud" src="src/assets/avatars/viewer1.jpg" />
                        <Box>
                            <Box sx={styles.commentDetailsSection}>
                                <Typography sx={styles.postMeta}>Daniela Junco</Typography>
                                <Typography sx={styles.postMeta}>2 weeks ago</Typography>
                            </Box>

                            <Typography sx={styles.commentText}>
                            Lions, the epitome of untamed majesty! Their regal presence and commanding roars send shivers down my spine.
                            </Typography>
                        </Box>
                        <Box
                            component="img"
                    ...
                    <Divider sx={styles.divider} />
                    <Box sx={styles.commentRow}>
                        <Avatar sx={styles.avatar} alt="Chris" src="src/assets/avatars/viewer2.jpg" />

                        <Box>
                            <Box sx={styles.commentDetailsSection}>
                                <Typography sx={styles.postMeta}>James Pontes</Typography>
                                <Typography sx={styles.postMeta}>2 weeks ago</Typography>
                            </Box>
                        ...
                        <Box
                            component="img"
                            sx={styles.videoThumbnail}
                            src="src/assets/dolphin.jpg"
                        />

                    </Box>
                    <Divider sx={styles.divider} />
                    <Box sx={styles.commentRow}>
                        <Avatar sx={styles.avatar} alt="" src="src/assets/avatars/me.png" />
                        <Box>
                            <Box sx={styles.commentDetailsSection}>
                                <Typography sx={styles.postMeta}>Travel Together</Typography>
                                <Typography sx={styles.postMeta}>2 weeks ago</Typography>
                            ...
                            <Typography sx={styles.commentText}>
                                Thank you for sharing this video, was so amazing!
                            </Typography>
                        </Box>
                ...
                <CardContent sx={styles.ideaContent}>
                    <Box>
                        ...
                        <Box
                            ...
                            src="src/assets/water.jpg"
                        />
                        <Typography sx={styles.ideaQuestion}>Cascading Wonder: Nature's Majestic Waterfall Symphony ?</Typography>
                        <Typography variant="h7">
                        Immerse yourself in the mesmerizing world of cascading wonder as nature unveils its majestic waterfall symphony. Feel the mist kiss your skin and the thunderous roar reverberate in your chest as you witness the sheer power and breathtaking beauty of water plunging with graceful force. This awe-inspiring spectacle serves as a reminder of the raw magnificence that Earth's natural wonders have to offer.
                        </Typography>
